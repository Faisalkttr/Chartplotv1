    ...
    "EM (7%)": {
        "Layer 1: India — Grid, Manufacturing, Consumption (50%)": {
            ...
            "tickers": ["6501.T", "CGPOWER.NS", "DIXON.NS", "KAYNES.NS", "HFCL.NS",
                        ...
                        "HINDCOPPER.NS", "DIACABS.NS"],
            "benchmark": "^NSEI"},
        "Layer 2: GCC (20%)": {
            "tickers": ["2222.SR", "ADNOCGAS", "2082.SR", "7010.SR"], "benchmark": "^TASI.SR"},
        "Layer 3: Other EM / China / LatAm (30%)": {
            "tickers": ["VALE", "TLK", "BABAF", "CHL", "CSUAY", "CEO", "YPF",
...
LIQUIDITY_WATCH = {"LYSCF", "IKTSY", "BABAF", "CSUAY", "CHL", "INDO", "ISDE", "ALMU",
                   "KAP.IL", "HIJP", "ADNOCGAS", "FUWAY"}
...
tab_grid, tab_adhoc, tab_sizing = st.tabs(["📊 Portfolio Grid", "🔍 Ad-Hoc Search", "🛡️ Sizing & Stress"])
with tab_grid:
